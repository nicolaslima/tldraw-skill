...
tldraw 不只有方框和箭头。因为它本质是带自由笔迹(`draw` shape)的**手绘白板**,这个 skill 也能拼出具象的小图 —— 用 geo 图元(ellipse / triangle / heart)加自由笔迹画不规则的部分(胡须、摇摆的尾巴):

<table>
  <tr>
    <td align="center" width="50%"><img src="assets/example-cat.png" width="210" alt="用椭圆、三角形、爱心鼻子拼成的猫,胡须和卷尾巴是自由笔迹"></td>
    <td align="center" width="50%"><img src="assets/example-dog.png" width="220" alt="垂耳、吐舌、自由笔迹摇尾的狗"></td>
  </tr>
</table>

<sub>这不是 skill 的<i>本职</i> —— 它是个图表工具 —— 但能有趣地展示自由笔迹 <code>draw</code> shape 和手绘风格。源文件:<a href="assets/example-cat.tldr">example-cat.tldr</a>、<a href="assets/example-dog.tldr">example-dog.tldr</a>。</sub>
